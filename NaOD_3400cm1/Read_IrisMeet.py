...
#        print(type(File))
        ...
        ###This function creates a class with several subclasses aabout the 
        ...
        print ('Number of complete scans: %d\n' % nscans)
...
#Data = Read(cd + '20180913_Water.dat')
...
#print ((Data.specs.p4v[0]))


#print (len(raw.s[0].pol))
